...
{
    /// <summary>Extensions for <see cref="AppDomain"/>.</summary>
    public static class AppDomainExtensions
    {
        /// <summary>
        /// Creates a type in an <see cref="AppDomain"/>. Loads the assembly
        ...
        /// (with <see cref="AppDomain.CreateDomain(string)"/>) and then use this
        /// method.
        /// </summary>
        /// <remarks>
